...
<script type = "text/javascript">
	...
	<script type = "text/javascript">
	function ConfirmDeleteTod()
	{
		var respuesta= confirm("¿Esta seguro de eliminar todos los pedidos?")
		if (respuesta==true)
		{
			return true;
		}
...
================================================== -->
			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="card-block">
						<form action="modDB/anadecarro.php?id=<?php echo $mostrar['nombre']?>&&usuario=<?php echo $usuario?>" method="POST"  enctype= "multipart/form-data">
						...
						<h4 class="card-text">
										...
										<input type="number" name="cantida" id="cantidad" min="1" max="5" step="1" placeholder="1">
                                        <div class="metafooter">
							<div class="wrapfooter">
								<span class="meta-footer-thumb">
								<input type="submit" class="btn btn-info" value="Añadir al carrito"><br>
				</form>
							</div>
						</div>
					</div>
	...
	<div class="card-columns listfeaturedtag">
		...
		<?php
			...
			?>
			<a href="modDB/eliminatodopedido.php?nombre=<?php echo $usuario?>"><botton type= "button" class="btn btn-danger" onclick="return ConfirmDeleteTod()">Eliminar todos los pedidos</botton></a>
		<?php
		}
		else{
			?>
