	...
	<div class="mainheading">
		...
		<div class="centro">
            <main>
                <section>
                     <header>
					Para visualizar los precios y poder realizar alg&uacute;na modificación es necesario que inicie sesión cliente
                    <br/>
					Si usted no es cliente, por favor vuelva a la página anterior
					<br/><br/><br/>
