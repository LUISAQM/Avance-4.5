...
<script type = "text/javascript">
	...
	{
		var respuesta= confirm("¿Esta seguro de eliminar todo el carrito?")
		if (respuesta==true)
		{
			return true;
		}
...
<section class="featured-posts">
	...
	<div class="card-columns listfeaturedtag">
		...
		<?php
			...
			<a href="modDB/vaciarcarrito.php?usuario=<?php echo $usuario?>"class="btn btn-danger" onclick="return ConfirmDeleteCa()" >Vaciar el carrito</a>
            <?php
		}
		else{
			?>
