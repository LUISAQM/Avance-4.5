...
$sql="SELECT * from pedidos where usuario = '$nombre' and activo = '1' ";
								...
								<?php
		 						...
		 						?>
                                            <tr>
                                                ...
                                                <a href="modDB/eliminapedido.php?id=<?php echo $mostrar['ID']?>&&usuario=<?php echo $usuario?>&&nombre=<?php echo $nombre?>"><button type="button" class="btn btn-danger" onclick="return ConfirmDeleteArt()">Eliminar articulo</button></a></th> 
                                                </td> 
                                            </tr>
                                    ...
                                    ?>
                                    <a href="modDB/pedidosurtido.php?usuario=<?php echo $usuario?>&&nombre=<?php echo $nombre?>"><button type="button" class="btn btn-danger" onclick="return ConfirmDeletePed() ">Pedido Surtido</button></a>
                                    <?php      
                                        }else{
                                                ?> 
                                        ...
                                        ?>
                            <a href="inicioempleado.php?usuario=<?php echo $usuario?>"><button type="button" class="btn btn-info">Regresar</button></a>   
                                            </tbody>
                            </table>
</body>
 <?php
