	...
	function ConfirmDelete()
	{
		...
		else
		{
			return false;
                            ...
                            <h1>Ingrese datos</h1>
                                <form action="modDB/modificar.php?usuario=<?php echo $mostrar['usuario']?>" method="POST"  enctype= "multipart/form-data">
								...
								<a href="inicioempleado.php?usuario=<?php echo $usuario?>"class="btn btn-info">Regresar</a><br>
                        </div>
