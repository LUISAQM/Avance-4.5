				...
				<div class="col-md-7">
					<div class="card-block">
						...
						<h4 class="card-text">
										...
										<a href="modificarplatillo.php?id=<?php echo $mostrar['ID']?>&&usuario=<?php echo $usuario?>" class="btn btn-info">Modificar Platillo</a> 
										<a href="modDB/eliminaplatillo.php?id=<?php echo $mostrar['ID']?>&&usuario=<?php echo $usuario?>"><button type = "button" class="btn btn-danger" onclick="return ConfirmDeletePla()">Eliminar Platillo</button></a>
				...
				<div class="col-md-7">
					<div class="card-block">
						...
						<div class="metafooter">
							<div class="wrapfooter">
								<span class="meta-footer-thumb">
								<a href="modDB/eliminapedido.php?id=<?php echo $mostrar['ID']?>&&usuario=<?php echo $usuario?>"><button type="button" class="btn btn-danger" onclick="return ConfirmDeletePed()">Eliminar pedido</button></a></th> 
								</span>    
							</div>
						</div>
					</div>
